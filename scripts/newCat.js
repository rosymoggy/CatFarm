...
class Cat {
  ...
  get radioHtml() {
	  return "" + 
		"<div class='radio'>" +
		"<label for='radio" + this.htmlId + "'>" + 
		"<input id='radio" + this.htmlId + "' type='radio' name='" + Cat.$prefix + "' value='" + this.code + "' />" + 
		"<span class='cat-title'>" + this.catTitle + "</span><span class='cat-info'>" + this.info + "</span>" +
		"</label>" +
		"</div>";
  }
  ...
  get checkboxHtml() {
	...
	return "" +
		"<div class='checkbox'>" +
		"<label for='checkbox" + this.htmlId + "'>" + 
		"<input id='checkbox" + this.htmlId + "' type='checkbox' name='" + Cat.$prefix + "' value='" + this.code + "' onclick='checkCatMate($(this));' />" + 
		"<span class='cat-title'>" + countText + this.catTitle + "</span><span class='cat-info'>" + this.info + "</span>" +
		"</label>" +
		"</div>";
}
  ...
  setSettingByCode(code) {
    ...
    this.furColor = catSetting.furColorArray[idxFurColor];
    ...
    this.kind = catSetting.kindArray[idxKind];
    ...
    this.leftEyeColor = catSetting.eyeColorArray[idxLeftEyeColor];
	...
	this.rightEyeColor = catSetting.eyeColorArray[idxRightEyeColor];
    ...
    this.furLength = catSetting.furLengthArray[idxFurLength];
    ...
    this.limbLength = catSetting.limbLengthArray[idxLimbLength];
	...
	this.gender = catSetting.genderArray[idxGender];
...
function createCat(catCount) {
	var array = [];
	var hasFather = false, hasMother = false;
...
function findCat(code) {
	var cat = undefined, tmpIdx = undefined;
	$.each(catArray, function(idx, item){
		if(item.code == code) {
			cat = item;
			tmpIdx = idx;
